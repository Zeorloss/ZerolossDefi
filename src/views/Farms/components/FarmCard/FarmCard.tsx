...
import { Card, Flex, Text, Skeleton, Tab, Tag, LockIcon, VerifiedIcon } from '@pancakeswap/uikit'
...
const widrawLockLabel = ['15 D', '15 D', '15 D', '15 D', '15 D', '15 D'];
    ...
    <StyledCard isActive={isPromotedFarm}>
      <FarmCardInnerContainer>
        ...
        <Flex justifyContent="space-between">
          ...
          <Tag variant="binance" startIcon={<LockIcon width="14px" color="gold" mr="4px" />}>
            {earnLabel}
          </Tag>
        </Flex>
