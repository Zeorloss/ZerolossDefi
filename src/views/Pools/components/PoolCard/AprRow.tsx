 ...
 // console.log("xxxxxAPR ", apr);
  ...
  return (
    <Flex alignItems="center" justifyContent="space-between">
      ...
      <TooltipText ref={targetRef} color="gold">{isAutoVault ? `${t('APY')}:` : `${t('APR')}:`}</TooltipText>
      {earningsPercentageToDisplay || isFinished ? (
        <ApyLabelContainer alignItems="center" onClick={onPresentApyModal}>
          ...
          />
          {!isFinished && (
            <IconButton variant="text" scale="sm" color='gold'>
              <CalculateIcon style={{fill: '#f0bc03' }} color="gold" width="18px"/>
            </IconButton>
          )}
        </ApyLabelContainer>
      ) : (
